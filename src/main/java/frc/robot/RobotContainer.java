...
public class RobotContainer {
  ...
  private final MecanumDrivetrain m_mecanumDrivetrain = new MecanumDrivetrain();

  private final ExampleCommand m_autoCommand = new ExampleCommand(m_exampleSubsystem);
  //private final DriveMecanum m_driveMecanum = new DriveMecanum(m_mecanumDrivetrain);
